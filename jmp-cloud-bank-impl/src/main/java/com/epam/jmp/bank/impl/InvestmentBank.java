...
/**
 * Implementation of the {@link Bank} interface representing an investment bank.
 * This class is responsible for creating bank cards for users based on the specified bank card type.
 */
public class InvestmentBank extends BankAbstract implements Bank {

    /**
     * Constructs a new InvestmentBank instance and initializes the creators map.
     * The creators map associates the CREDIT {@link BankCardType} with a function that creates a {@link CreditBankCard}.
     */
